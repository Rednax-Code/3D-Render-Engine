...
# Adding first shape
object_list.append(render3D.shapes.cuboid([0,0,2000], [500, 500, 500], None))

#object_list.append(render3D.shapes.camerathing([0,00,1500], None))
...
while True:
	...
	for i in input_list:
		if inputs[i]:
			...
			if i in inputs_camera_rotate:
				#object_list[0].rotate(inputs_camera_rotate[i])
	...
	# Render all objects
	render3D.render(screen, object_list)
